...
def build_html_report(jobs: list, report_date: str) -> str:
    """Build a styled HTML email report from scored jobs."""
    ORDER = {"HIGH": 0, "MEDIUM": 1, "LOW": 2}
    jobs  = sorted(
        jobs,
        key=lambda j: (ORDER.get(j.get("priority", "LOW"), 3),
    ...
    def breakdown_bars(bd: dict, color: str) -> str:
    ...
    def skill_tags(skills: list, color: str) -> str:
        return "".join(
    ...
    def pri_badge(priority: str, color: str) -> str:
        return (
...
<body style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',
  ...
  <div style="text-align:center;font-size:11px;color:#94a3b8;
    ...
    Job Intel Agent v2.0 &nbsp;·&nbsp; CrewAI + Groq + Ollama &nbsp;·&nbsp;
    All free tools
  </div>
</body>
</html>"""
